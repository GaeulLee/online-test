...
<div>
	...
	<a href="${pageContext.request.contextPath}/teacher/test/testList">시험문제관리</a> <!-- 강사만 관리 권한 -->
	<a href="${pageContext.request.contextPath}/teacher/test/testList">문제보기관리</a> <!-- 강사만 관리 권한 -->
