                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<div class="mx-4" style="font-size: 17px;">
									<a data-toggle="modal" href="#add"><!-- 사원등록 모달버튼 -->
												...
												<form action="${pageContext.request.contextPath}/employee/addEmp" method="post" id="addForm">
													<table class="table table-borderless" style="color: #3d4465; font-size: 17px;">
														...
														<tr>
															...
															<td>
																<input type="text" name="empId" id="id" value="${userTId}" readonly="readonly" class="form-control">
															</td>
														</tr>
														<tr>
															<th class="text-center">이름</th>
															<td>
																<input type="text" name="empName" id="name" value="${userTName}" class="form-control">
															</td>
														</tr>
														<tr>
															<th class="text-center">비밀번호</th>
															<td>
																<input type="password" name="empPw" id="pw" value="${userTPw}" class="form-control">
															</td>
														</tr>
													</table>
			                                            ...
			                                            <div class="modal-content">
			                                                ...
			                                                <div class="modal-footer">
			                                                    ...
			                                                    <button type="submit" class="btn btn-primary"
			                                                    		onclick="location.href='${pageContext.request.contextPath}/employee/deleteEmp?empNo=${e.empNo}'">삭제</button>
			                                                </div>
			                                            </div>
			                                        </div>
			                                    </div>
								...
								<nav>
                                    <ul class="pagination pagination-circle"  style="justify-content: center;">
										...
										<c:forEach varStatus="a" begin="${startPage}" end="${endPage}" step="1">
											...
											<c:if test="${a.current != currentPage}">
												<li class="page-item">
													<a class="page-link" href="${pageContext.request.contextPath}/employee/empList?currentPage=${a.current}&searchWord=${searchWord}">${a.current}</a>
												</li>
											</c:if>
										</c:forEach>
