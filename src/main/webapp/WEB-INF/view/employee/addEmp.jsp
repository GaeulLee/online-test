	...
	<form action="${pageContext.request.contextPath}/employee/addEmp" method="post" id="addForm">
		<table>
			...
			<tr>
				<th>아이디</th>
				<td>
					<input type="text" name="empId" id="id" value="${userEmpId}" readonly="readonly">
				</td>
			</tr>
			<tr>
				<th>이름</th>
				<td>
					<input type="text" name="empName" id="name" value="${userEmpName}">
				</td>
			</tr>
			<tr>
				<th>비밀번호</th>
				<td>
					<input type="password" name="empPw" id="pw" value="${userEmpPw}">
				</td>
			</tr>
			<tr>
				<td colspan="2">
