                        ...
                        <div class="card">
                            <div class="card-body">
								...
								<div class="mx-4" style="font-size: 17px;">
									<a data-toggle="modal" href="#add"><!-- 학생등록 모달버튼 -->
												...
												<form action="${pageContext.request.contextPath}/employee/student/addStudent" method="post" id="addForm">
													<table class="table table-borderless" style="color: #3d4465; font-size: 17px;">
														...
														<tr>
															...
															<td>
																<input type="text" name="studentId" id="id" value="${userTId}" readonly="readonly" class="form-control">
															</td>
														</tr>
														<tr>
															<th class="text-center">이름</th>
															<td>
																<input type="text" name="studentName" id="name" value="${userTName}" class="form-control">
															</td>
														</tr>
														<tr>
															<th class="text-center">비밀번호</th>
															<td>
																<input type="password" name="studentPw" id="pw" value="${userTPw}" class="form-control">
															</td>
														</tr>
													</table>
			                                            ...
			                                            <div class="modal-content">
			                                                ...
			                                                <div class="modal-footer">
			                                                    ...
			                                                    <button type="submit" class="btn btn-primary"
			                                                    		onclick="location.href='${pageContext.request.contextPath}/employee/student/removeStudent?studentNo=${s.studentNo}'">삭제</button>
			                                                </div>
			                                            </div>
			                                        </div>
			                                    </div>
                                    ...
                                    <ul class="pagination pagination-circle"  style="justify-content: center;">
                                        ...
                                        <li class="page-item page-indicator">
											...
											<c:if test="${currentPage > 1}">
												...
												<a class="page-link" href="${pageContext.request.contextPath}/employee/student/studentList?currentPage=${currentPage-1}&searchWord=${searchWord}">
										...
										<c:forEach varStatus="a" begin="${startPage}" end="${endPage}" step="1">
											...
											<c:if test="${a.current != currentPage}">
												<li class="page-item">
													<a class="page-link" href="${pageContext.request.contextPath}/employee/student/studentList?currentPage=${a.current}&searchWord=${searchWord}">${a.current}</a>
												</li>
											</c:if>
										</c:forEach>
